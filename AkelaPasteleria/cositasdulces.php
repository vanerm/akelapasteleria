    ...
    <p> hola aca van a ir varias imagenes de las cositas dulces>..</p>
		...
		<section class="vip-products">
			<article class="product">
				<img src="images/browny.jpg" alt="Responsive image" class="img-thumbnail">
				<h2>Torta de Chocolate</h2>
			</article>
			<article class="product">
				<img src="images/tarta_chocolate.png" alt="Responsive image" class="img-thumbnail">
      ...
      <article class="product">
				<img src="images/marquise.png" alt="Responsive image" class="img-thumbnail">
				<h2>Lorem ipsum amet</h2>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut recusandae eaque debitis sint necessitatibus, officia ex.</p>
				<a href="#">ver más</a>
			</article>
